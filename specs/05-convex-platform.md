...
No STDB instance exists during config mode; the board preview is generated and persisted entirely within Convex. *(Amended per 08-REVIEW-015 resolution: persistence is unconditional on every regeneration; `boardPreviewLocked` flag governs reuse vs. regenerate at launch. Preserves 05-REVIEW-008 resolution: board preview persisted on game record, not room record.)*
